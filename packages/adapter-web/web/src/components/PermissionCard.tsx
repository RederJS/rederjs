...
export function PermissionCard({
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-2 font-mono text-[10.5px] uppercase tracking-[0.08em]"
        style={{ color: 'var(--st-busy)' }}
      >
        <span
          className="size-1.5 rounded-full animate-dot-blink"
          style={{ background: 'var(--st-busy)', boxShadow: '0 0 6px var(--st-busy)' }}
        />
